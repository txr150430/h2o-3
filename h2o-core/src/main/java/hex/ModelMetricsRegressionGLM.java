...
public class ModelMetricsRegressionGLM extends ModelMetricsRegression implements GLMMetrics {
  ...
  public ModelMetricsRegressionGLM(Model model, Frame frame, long nobs, double mse, double mae, double sigma, double resDev, double meanResDev, double nullDev, double aic, long nDof, long rDof) {
    super(model, frame, nobs, mse, mae, sigma, meanResDev);
    _resDev = resDev;
    _nullDev = nullDev;
    _AIC = aic;
