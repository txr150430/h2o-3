...
public class SSLEncryptionTest extends TestUtil {
    ...
    public static void testGBMRegressionGaussianSSL() {
        stall_till_cloudsize(new String[] {"-ssl_config", SSLEncryptionTest.class.getResource("/ssl.properties").getPath()}, 3);
        testGBMRegressionGaussian();
    }
